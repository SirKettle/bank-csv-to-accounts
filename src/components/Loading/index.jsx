      ...
      return (
        <LoadingContainer status={uiStatus}>
          <ImageContainer>
            ...
            {uiStatus === LOADING_STATUS.ERROR ? <Paragraph>{errorMessage}</Paragraph> : null}
            {uiStatus !== LOADING_STATUS.ERROR && loadingMessage ? <Paragraph>{loadingMessage}</Paragraph> : null}
          </ImageContainer>
        </LoadingContainer>
      );
  }
